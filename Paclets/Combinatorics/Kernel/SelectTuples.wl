...
SelectTuples::usage="SelectTuples[poset] determines if the coordinates in poset are partially ordered.";

SelectTuples[poset_]:=Module[{sortedlast,sortedfirst,gatherfirst,gatherlast},If[!MatrixQ[poset,IntegerQ],Return[False,Module]];sortedlast=GatherBy[Sort[poset],Last];
