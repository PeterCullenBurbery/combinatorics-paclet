...
ToInversionVector::usage="ToInversionVector[poset] determines if the coordinates in poset are partially ordered.";

ToInversionVector[poset_]:=Module[{sortedlast,sortedfirst,gatherfirst,gatherlast},If[!MatrixQ[poset,IntegerQ],Return[False,Module]];sortedlast=GatherBy[Sort[poset],Last];
